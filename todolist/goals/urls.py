...
urlpatterns = [
    path('goal_category/create', views.GoalsCategoryCreateView.as_view(), name='category_create'),
    path('goal_category/list', views.GoalsCategoryListView.as_view()),
    path('goal_category/<int:pk>', views.GoalsCategoryView.as_view(), name='category'),
    path('goal/create', views.GoalsCreateView.as_view(), name='goal_create'),
    path('goal/list', views.GoalsListView.as_view()),
    path('goal/<int:pk>', views.GoalsView.as_view(), name='goal'),
